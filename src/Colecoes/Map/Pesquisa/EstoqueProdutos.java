...
public class EstoqueProdutos {
    ...
    public Produto obterProdutoMaisCaro(){
        ...
        double maiorPreco = Double.MIN_VALUE;   // maiorPreco começará tendo o menor valor possível para um double
        if (!estoqueProdutos.isEmpty()){
            for (Produto p: estoqueProdutos.values()){
    ...
    public Produto obterProdutoMaisBarato(){
        ...
        double menorPreco = Double.MAX_VALUE;   // menorPreco começará tendo o maior valor possível para um double
        if (!estoqueProdutos.isEmpty()){
            for (Produto p: estoqueProdutos.values()){
    ...
    public static void main(String[] args) {
        ...
        Produto produtoMaiorQuantidadeValorTotal = estoque.obterProdutoMaiorValorTotalNoEstoque();
