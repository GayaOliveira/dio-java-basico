...
public class ConjuntoConvidados {
        ...
        if (!convidadosSet.isEmpty()) {
            for (Convidado c : convidadosSet) {
                if (c.getCodigoConvite() == codigoConvite) {
                    ...
                    break;   // como cada elemento do Set é único, posso quebrar o laço assim que eu encontrar o que procuro
                }
            }
    ...
    public static void main(String[] args) {
        ...
        conjuntoConvidados.adicionarConvidado("Charlie", 1235);  // código repetido -->
